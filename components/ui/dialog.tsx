...
function DialogHeader({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-start gap-2 border-b border-border p-4 pr-14",
        className
      )}
      {...props}
    >
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-2 p-6 sm:flex-row sm:items-center sm:justify-end",
        className
      )}
      {...props}
    >
